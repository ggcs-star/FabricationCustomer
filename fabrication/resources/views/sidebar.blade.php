...
<style>
    ...
    * {
    ...
    /* ===== OVERRIDE APP LAYOUT ===== */
    /* The header is provided by app.blade.php, we need to position sidebar below it */
    .app-layout {
        display: flex;
    ...
    /* Hide the sidebar header/brand that might be in the component */
    ...
    @media (max-width: 820px) {
        ...
        /* Show the user info in mobile view */
        .profile-sidebar .user-info {
