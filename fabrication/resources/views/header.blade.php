    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        <nav class="flex items-center justify-between h-16">
            ...
            <ul class="hidden lg:flex items-center gap-8">
                <li>
                    <a href="/services" class="text-white text-sm font-medium hover:text-[#FF8C00] transition duration-300" id="nav-services">
                        Services
                    </a>
                </li>
                <li>
                    <a href="/vendors" class="text-white text-sm font-medium hover:text-[#FF8C00] transition duration-300" id="nav-vendors">
                        Vendors
                    </a>
                </li>
                <li>
                    <a href="/how-it-works" class="text-white text-sm font-medium hover:text-[#FF8C00] transition duration-300" id="nav-how-it-works">
                        How it works
                    </a>
                </li>
                <li>
                    <a href="/amc-plans" class="text-white text-sm font-medium hover:text-[#FF8C00] transition duration-300" id="nav-amc">
                        AMC Plans
                    </a>
                </li>
            </ul>
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-black border-t border-gray-800">
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 py-4">
            <ul class="flex flex-col gap-4">
                <li><a href="/services" class="text-white text-sm block hover:text-[#FF8C00] transition">Services</a></li>
                <li><a href="/vendors" class="text-white text-sm block hover:text-[#FF8C00] transition">Vendors</a></li>
                <li><a href="/track-project" class="text-white text-sm block hover:text-[#FF8C00] transition">Track Project</a></li>
                <li><a href="/amc-plans" class="text-white text-sm block hover:text-[#FF8C00] transition">AMC Plans</a></li>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const navLinks = document.querySelectorAll('#main-header .hidden.lg\\:flex a');
